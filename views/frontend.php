...
<script>
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        ...
        <?php if (isset($_COOKIE['triad_gdpr_consent']) && $_COOKIE['triad_gdpr_consent'] == 'yes'): ?>
            ...
            elem.outerHTML = '<?=$revoke_html?>';
            <?php else: ?>
            elem.outerHTML = '<div class="triad_gdpr" id="triad_gdpr_revoke"><p><button id="triad_gdpr_revoke_btn">Remove Cookies</button><?=$revoke_message?></p></div>';
            <?php endif;?>
        ...
        <?php else: ?>
            ...
            elem.outerHTML = '<?=$consent_html?>';
            <?php else: ?>
            elem.outerHTML = '<div class="triad_gdpr" id="triad_gdpr_consent"><p><button id="triad_gdpr_consent_btn">Allow Cookies</button><?=$consent_message?></p></div>';
            <?php endif;?>
            document.addEventListener('click',function(event) {
